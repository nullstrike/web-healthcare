    ...
    $.fn.autocomplete = function (options) {
      ...
      return this.each(function () {
        ...
        if (!$.isEmptyObject(data)) {
          var $autocomplete = $('<ul id="autocomplete" class="autocomplete-content dropdown-content"></ul>');
          var $oldAutocomplete;
          ...
          var highlight = function (string, $el) {
            ...
            $el.html('<input hidden value="' + val + '">' + "<span>" + beforeMatch + "<span class='highlight'>" + matchText + "</span>" + afterMatch + "</span>");
            /*------------ORIGINAL_VERSION-----------------
             var img = $el.find('img');
            var matchStart = $el.text().toLowerCase().indexOf("" + string.toLowerCase() + ""),
                matchEnd = matchStart + string.length - 1,
              ...
              if (val.length >= options.minLength) {
                for (var key in data) {
                  if (data.hasOwnProperty(key) && key.toLowerCase().indexOf(val) !== -1) {
                    ...
                    if (!!data[key]) {
                      /*-------EDITED_VERSION-------*/
                        autocompleteOption.append('<label>'+'Patient id: ' + data[key] + '</label>' + '  -  ' + '<span>' + key + '</span>' + '<input type="hidden" value="' + data[key] + '">');
                     /*--------ORIGINAL_VERSION-----/
          ...
          $autocomplete.off('mousedown.autocomplete touchstart.autocomplete').on('mousedown.autocomplete touchstart.autocomplete', 'li', function () {
           //edited_version
            ...
            //original version var text = $(this).text().trim();
