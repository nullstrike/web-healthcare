...
$(document).ready(function(){
    ...
    $.ajax({
      url: site_url('statistics/getPatientNewStat'),
      data:{},
      type: 'get',
      dataType: 'text',
      success: function(figures) {
          $('#new_patient_num').text(figures);
      }
    });
...
data: {
  ...
  datasets: [
    {
      label: "Number of common symptoms diagnosed",
      backgroundColor: ["#3e95cd", "#8e5ea2","#3cba9f","#e8c3b9","#c45850"],
      data: [12,24,125,23,53]
    }
  ]
},
options: {
